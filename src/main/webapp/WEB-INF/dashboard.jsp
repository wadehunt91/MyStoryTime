		...
		<nav class="navbar navbar-expand-lg navbar-light">
	  		...
	  		<div class="collapse navbar-collapse" id="navbarSupportedContent">
	    		<ul class="navbar-nav ml-auto">
	      			...
	      			<li class="nav-item">
	        			<a class="nav-link" href="/view/author/${user.id}/${currentPage}">My Stories</a>
	      			</li>
	      			<li class="nav-item">
				  ...
				  <ul class="pagination justify-content-center">
					    <li class="page-item">
					      <c:if test="${currentPage != 1 }">
					      		<a class="page-link page text-white" href="${currentPage - 1}">Previous</a>
					      	</c:if>
					    </li>
				    	...
				    	<li>
				    		<c:if test="${currentPage != totalPages }">
					      		<a class="page-link page text-white" href="${currentPage + 1}">Next</a>
					      	</c:if>
					    </li>
				  </ul>
			</nav>
